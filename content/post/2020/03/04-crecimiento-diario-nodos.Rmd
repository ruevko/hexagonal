...
```{r model-sel, dev="png", fig.asp=1.2, fig.cap="Regresiones lineales ajustadas en países seleccionados"}
...
```{r model-low, dev="png", fig.asp=.9, fig.cap="Regresiones lineales ajustadas con coeficiente de determinación menor a 0.70"}

...
EC_COVID19 = data.frame(
   fuente = c(rep("Salud_Ec", 9), rep("Riesgos_Ec", 17)),
   status = c(
      "1233774191326957575",
      "1234331734889697281",
      "1234670644878462980",
   ...
   corte = as.POSIXct(c(
      ...
      "2020-03-22 10:00"), #18
      "America/Guayaquil"),
   cerco = c(rep(NA, 9),279,279,317,273,273,273,315,451,NA,575,575,746,746,1213,1213,1213,1347),
   negativo = c(rep(NA, 12), 51, 51, 51, 51, 51, 278, 312, 336, 412, 483, 533, 601, 649, 872),
   positivo =c(1,6,7,10,13,14,15,17,19,23,23,28,37,37,58,58,111,155,168,199,260,367,426,506,532,789),
   fallecido = c(rep(0, 9), 1, 1, rep(2, 7), 3, 3, 4, 5, 7, 7, 7, 14))

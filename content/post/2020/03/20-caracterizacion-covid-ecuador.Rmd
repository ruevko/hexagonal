...
EC_COVID19 = data.frame(
   fuente = c(rep("Salud_Ec", 9), rep("Riesgos_Ec", 23)),
   status = c(
      "1233774191326957575",
      "1234331734889697281",
      "1234670644878462980",
   ...
   cerco = c(rep(NA, 9), 279, 279, 317, 273, 273, 273, 315, 451, NA, 575, 575,
             746, 746, 1213, 1213, 1213, 1347, 1347, 1347, NA, NA, NA, NA),
   negativo = c(rep(NA, 12), 51, 51, 51, 51, 51, 278, 312, 336, 412, 483,
                533, 601, 649, 872, 1091, 1211, 1225, 1346, 1387, 1676),
   positivo = c(1, 6, 7, 10, 13, 14, 15, 17, 19, 23, 23, 28, 37, 37, 58, 58, 111, 155,
                168, 199, 260, 367, 426, 506, 532, 789, 981, 1049, 1082, 1173, 1211, 1382),
   fallecido = c(rep(0, 9), 1, 1, rep(2, 7), 3, 3, 4, 5, 7, 7, 7, 14, 18, 27, 27, 28, 29, 34))
...
```{r table}
EC_COVID19 = EC_COVID19[-c(11, 14, 16, 19, 21, 23, 25, 29, 31), c(1, 4, 7, 8)]

...
output:
   blogdown::html_page:
      highlight: kate
thumbnailImage: https://pbs.twimg.com/media/ENzwak5XsAATLc0?format=jpg&name=small
...
data.frame(v0 = c("[#ParoNacionalEcuador ](https://twitter.com/search?q=%23ParoNacionalEcuador",
   ...
   knitr::kable(col.names = c("hashtag", "tweets (1)", "tweets únicos (2)",
                              "porcentaje (2÷1)", "usuarios (3)", "razón (1÷3)"))

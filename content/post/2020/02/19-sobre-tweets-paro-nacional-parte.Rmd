...
`r knitr::opts_chunk$set(fig.height=3.5, out.width="100%"); library(dplyr); df_all=readRDS("PNE2019.RDS")`
...
```{r plot2, warning=FALSE, fig.cap="Boxplots de favorites y retweets por hashtag"}
library(tidyr)
...
La siguiente tabla presenta las combinaciones de *hashtags* -mostrando solo iniciales- que aparecieron. `r knitr::kable(df_wide[rowSums(df_wide[grep("#", names(df_wide))] == "\U2713") > 1, ], align = "ccccccrr", caption = "Resumen de los tweets con hashtags combinados")`
...
```{r plot3, echo=FALSE, fig.cap="Usuarios que publicaron diez o más tweets por hashtag"}
...
```{r plot4, echo=FALSE, message=FALSE, fig.cap="Tiempo de publicación de los tweets por hashtag"}
